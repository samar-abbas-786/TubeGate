...
const Hero = () => {
  return (
    <section className="relative bg-gradient-to-b  from-black pt-28 md:pt-24  to-black min-h-[90vh] flex items-center justify-center px-6 md:px-12 overflow-hidden">
